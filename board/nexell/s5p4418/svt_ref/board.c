...
static const char boot_args[] = "setenv bootargs console=ttyAMA0,115200n8 loglevel=7 printk.time=1 androidboot.hardware=svt_ref androidboot.console=ttyAMA3 androidboot.serialno=0123456789ABCDEF nx_rearcam.sensor_init_parm=1 quiet";
