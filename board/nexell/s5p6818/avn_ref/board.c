...
static const char boot_args[] = "setenv bootargs console=ttySAC3,115200n8 loglevel=7 printk.time=1 androidboot.hardware=avn_ref androidboot.console=ttySAC3 androidboot.serialno=0123456789abcdef nx_rearcam.sensor_init_parm=1 quiet";
