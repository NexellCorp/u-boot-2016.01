...
#define CONFIG_SYS_PROMPT			"s5p4418_smart_voice# "
#endif
...
#define CONFIG_EXTRA_ENV_SETTINGS	\
	...
	"boot_cmd_mmcboot="   \
		"ext4load mmc 0:1 $kerneladdr $kernel_file; ext4load mmc 0:1 $fdtaddr s5p4418-smart_voice-rev00.dtb; bootz $kerneladdr - $fdtaddr\0" \
