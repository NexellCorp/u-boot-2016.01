...
#define CONFIG_FASTBOOT_BUF_ADDR 0x76000000
...
#define CONFIG_SYS_PROMPT		"s5p4418_svt_ref# "
#endif
...
#define CONFIG_BOOTCMD "bootargs=console=ttyAMA0,115200n8 root=/dev/mmcblk0p3 rw rootfstype=ext4 init=/usr/bin/bootanimation loglevel=4 rootwait quiet " \
                        "printk.time=1 consoleblank=0 nx_drm.fb_buffers=3 coherent_pool=4M systemd.log_level=info systemd.show_status=false\0"
#else
#define CONFIG_BOOTCMD "bootargs=console=ttyAMA0,115200n8 root=/dev/mmcblk0p3 rw rootfstype=ext4 loglevel=4 rootwait quiet " \
                        "printk.time=1 consoleblank=0 nx_drm.fb_buffers=3 coherent_pool=4M systemd.log_level=info systemd.show_status=false\0"
#endif
