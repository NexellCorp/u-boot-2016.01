...
#define CONFIG_SYS_PROMPT			"s5p4418_allo_display# "
#endif
...
#define CONFIG_FASTBOOT_BUF_SIZE        (CONFIG_SYS_SDRAM_SIZE -\
					CONFIO_FASTBOOT_RESERVE_BUF_SIZE - (32 * SZ_1M) )
...
#define CONFIG_EXTRA_ENV_SETTINGS	\
	...
	"boot_cmd_mmcboot="   \
		"ext4load mmc 0:1 $kerneladdr $kernel_file; ext4load mmc 0:1 $fdtaddr s5p4418-allo_display-rev01.dtb; bootz $kerneladdr - $fdtaddr\0" \
